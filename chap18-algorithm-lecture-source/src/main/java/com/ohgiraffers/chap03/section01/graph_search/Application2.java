...
public class Application2 {
    ...
    /* 설명. 방문배열 */
    static boolean[][] visit; //양방향(무방향) 관계이거나 대각선에 대칭되는 표가 아니다.
    ...
    /* 설명. 이 문제를 풀기위해서 배추 하나하나를 Node 객체로 다룸 */
    static class Node {
    ...
    public static Integer solution(String input) throws IOException {
        ...
        M = Integer.parseInt(st.nextToken()); //배추밭 넓이
