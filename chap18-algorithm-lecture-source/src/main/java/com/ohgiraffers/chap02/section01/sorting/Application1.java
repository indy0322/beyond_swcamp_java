...
//        System.out.println(Arrays.toString(arr));
        ...
        try(BufferedReader br = new BufferedReader(new InputStreamReader(System.in))){
            int length = Integer.parseInt(br.readLine()); //가급적 한줄을 문자열로 읽러 숫자로 바꿀 때는
                                                          // Integer.valueOf 대신 Integer.parseInt 사용

            /* 설명. 한줄 문자열 파싱하기 */
            /* 설명. 1. split을 활용(정규표현식 해석으로 인해 StringTokenizer보다 시간이 약간 더 걸림) */
...
//            }
            ...
            /* 설명. 2. StringTokenizer 활용(가장 속도 빠름)*/
