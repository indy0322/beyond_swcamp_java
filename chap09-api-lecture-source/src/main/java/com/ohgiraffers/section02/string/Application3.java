...
public class Application3 {
    public static void main(String[] args) {
        ...
        String str4 = "JAVA";
        String str5 = "mariaDB";
        System.out.println(str2.compareTo(str3)); //0이면 같은 것
        System.out.println(str3.compareTo(str4)); // 106 - 74
        System.out.println((int)'j'); // 106
        ...
        System.out.println("indexOf('a'): " + str6.indexOf('a')); // 1
        System.out.println("indexOf('z'): " + str6.indexOf('z')); // -1

        /* 설명. 2번 인덱스부터 우측으로 'a'를 찾아서 발견한 위치의 index값 반환 */
        System.out.println("indexOf('a'): " + str6.indexOf('a', 2));
        ...
        System.out.println("substring(3, 6): " + javamariaDB.substring(3, 6)); // 3,4,5 인덱스의 문자를 출력
        System.out.println("substring(3): " + javamariaDB.substring(3)); //

        /* 설명. 8. replace() */
        System.out.println("replace(): " + javamariaDB.replace("java", "python"));
        System.out.println("javamariaDB: " + javamariaDB); //원본을 건드리지 않음.
