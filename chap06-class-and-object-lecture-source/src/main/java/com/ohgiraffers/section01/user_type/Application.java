...
public class Application {
    ...
    * */
    ...
    public static void main(String[] test) {
         ...
         *     (냄새나는 코드 -> 리펙토링의 징조)
         *  3. 메소드의 반환형으로는 하나의 타입만 가능하지만 클래스가 없이는 여러 속성을 반환하는 것이 불가능하다.
        * */
        ...
        System.out.println("개병 이후 이름: " + member2.name);
        System.out.println("메소드를 호출할 때 넘겨준 num의 값: " + num);

        /* 설명.
         *  기본자료형의 값을 넘길 때 vs 참조자료형의 값을 넘길 때
         *  1. 기본자료형은 메소드를 호출한 곳이 영향을 받지 않는다.
         *  2. 참조자료형은 메소드를 호출한 곳이 영향을 받을 수 있다(feat. 반환을 할 필요없다.)
        * */
    }
